...
- **Breaking** - Changed mini-library names to their plurals to sound more
  natural. Not goig to affect anyone since no one is even using this package
  yet.
- Added event support!
...
- Change imports:
   - From `package:owl_mediator/query.dart` to
     `package:owl_mediator/queries.dart`;

   - From `package:owl_mediator/command.dart` to
     `package:owl_mediator/commands.dart`;
...
- Fixed the example readme file.
  Capitalisation had to change from `readme.md` to `README.md`.
